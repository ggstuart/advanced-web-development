...
{{<iframe src="examples/flex/fd.html" width="1000" height="150">}}{{</iframe>}}

`justify-content` controls how elements are distributed on the *main axis*.

{{<iframe src="examples/flex/jc.html" width="1000" height="150">}}{{</iframe>}}

`align-items` controls how elements are placed on the *cross-axis*.

{{<iframe src="examples/flex/ai.html" width="1000" height="150">}}{{</iframe>}}

`gap` sets the minimum space between elements.

{{<iframe src="examples/flex/gap.html" width="1000" height="150">}}{{</iframe>}}
